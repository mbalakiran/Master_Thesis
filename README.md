...
Figure 5: “Boxplot of the Brains over Static Environment”, the above figure describes the performance of the brains in different static environments in a boxplot. On each figure the X-axis defines the different kinds of brains, on the Y-axis defines the performance of the brains in the specific environment.
